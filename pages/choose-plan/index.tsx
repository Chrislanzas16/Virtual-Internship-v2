      ...
      <div className={styles["plan__header--wrapper"]}>
        <div className={styles.plan__header}>
          ...
          <figure className={styles["plan__img--mask"]}>
            <Image src={priceTop} alt="pricing" />
          </figure>
        </div>
      </div>
      <div className="row">
        <div className="container">
          ...
          <div
            className={`${styles["plan__card"]} ${
              activePlan === "yearly" ? styles["plan__card--active"] : " "
            }`}
          ...
          >
            <div className={styles["plan__card--circle"]}>
              <div
                className={
                  activePlan === "yearly" ? styles["plan__card--dot"] : ""
                }
              ></div>
            </div>
          ...
          <div
            className={`${styles["plan__card"]} ${
              activePlan === "monthly" ? styles["plan__card--active"] : " "
            }`}
          ...
          >
            <div className={styles["plan__card--circle"]}>
              <div
                className={
                  activePlan === "monthly" ? styles["plan__card--dot"] : ""
                }
              ></div>
            </div>
            <div className={styles["plan__card--content"]}>
